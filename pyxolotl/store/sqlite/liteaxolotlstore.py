...
class LiteAxolotlStore(AxolotlStore):
    def __init__(self, db, cryptostorage):
        ...
        self.identityKeyStore = LiteIdentityKeyStore(conn, cryptostorage)
        self.preKeyStore = LitePreKeyStore(conn, cryptostorage)
        self.signedPreKeyStore = LiteSignedPreKeyStore(conn, cryptostorage)
        self.sessionStore = LiteSessionStore(conn, cryptostorage)
